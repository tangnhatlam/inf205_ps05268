<%-- 
    Document   : showcart
    Created on : Oct 15, 2017, 8:28:50 AM
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="shopping-item">
                            <a href="showcart.jsp">Cart - <span class="cart-amunt"></span> <i class="fa fa-shopping-cart"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li  class="active"><a href="showcart.jsp">Cart</a></li>
                        </ul>
                    </div>  
                </div>
            </div>
                                    ...
                                    <table border="1" class="shop_table">
                                        <thead>
                                            <tr>
                                                ...
                                                <td class="product-f-image">Image</td>
                                        ...
                                        <form action="ControllerCartBean">
                                            ...
                                            <c:forEach var="rows" items="${shop}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="product-name">${rows.value.sanpham.name}</td>
                                                    <td class="product-price">${rows.value.sanpham.price}</td>
                                                    <td class="product-price"><img style="height:100px;width: 100px;" src="img/${rows.value.sanpham.image}"/></td>
                                                    <td class="product-quantity"><div class="quantity button_added"><input type="number" size="4" class="input-text qty text" title="Qty" value="${rows.value.quantity}" min="0" step="1"></div></td>
                                                    <td class="product-remove"><input type="checkbox" name="rmv"
